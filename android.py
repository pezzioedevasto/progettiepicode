...
def main():
    idVendor = input("Inserisci l'ID del fornitore (idVendor) del dispositivo USB (in esadecimale): ")
    idProduct = input("Inserisci l'ID del prodotto (idProduct) del dispositivo USB (in esadecimale): ")
    idVendor = int(idVendor, 16)  # Converti l'ID del fornitore in intero da esadecimale
    idProduct = int(idProduct, 16)  # Converti l'ID del prodotto in intero da esadecimale
